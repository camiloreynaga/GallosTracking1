 ...
 */
class Type extends Erp_startedActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, type, active, create_time, create_user_id, update_time, update_user_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'r_roosters' => array(self::HAS_MANY, 'Rooster', 'type_id'),
		);
	}
